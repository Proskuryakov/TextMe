...
INSERT INTO message_statuses VALUES (0, 'SENT');
INSERT INTO message_statuses VALUES (1, 'RECIEVED');
INSERT INTO message_statuses VALUES (2, 'DELETED');
...
INSERT INTO app_roles VALUES (0, 'ROLE_USER');
INSERT INTO app_roles VALUES (1, 'ROLE_MODER');
INSERT INTO app_roles VALUES (2, 'ROLE_ADMIN');
...
INSERT INTO chat_roles VALUES (0, 'ROLE_MEMBER');
INSERT INTO chat_roles VALUES (1, 'ROLE_MODER');
INSERT INTO chat_roles VALUES (2, 'ROLE_OWNER');
...
CREATE TABLE IF NOT EXISTS user_chat_role (
    ...
    chat_id     INTEGER         NOT NULL,
    role_id     INTEGER         NOT NULL,
    CONSTRAINT user_chat_role_pkey PRIMARY KEY (user_id, role_id),
