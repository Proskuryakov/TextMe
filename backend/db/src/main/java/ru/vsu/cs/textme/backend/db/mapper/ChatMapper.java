...
public interface ChatMapper {
    ...
    ChatMembers findChatInfoById(Integer id);
    ...
    List<UserChatInfo> findChatMembers(Integer id);
    ...
    @Select("SELECT * FROM chats WHERE id = #{id}")
    @Results(id = "ChatProfileInfoResult", value = {
            @Result(property = "id", column = "id"),
            @Result(property = "title", column = "title"),
            @Result(property = "imageUrl", column = "image_id", one = @One(select = "findAvatarByChatId")),
            @Result(property = "card", column = "card_id", one = @One(select = "findCardById")),
    })
    ChatProfileInfo findChatProfileInfoById(Integer id);
    ...
    List<ChatProfileInfo> findNearbyChatCards(Integer id, Integer limit, Integer offset);
